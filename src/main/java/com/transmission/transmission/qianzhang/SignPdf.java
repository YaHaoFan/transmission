package com.transmission.transmission.qianzhang;
...
//            numberOfPages = numberOfPages == null ? reader.getNumberOfPages() : 0;
            ...
            MakeSignature.signDetached(sap, digest, signature, chain, null,
                    null, null, 0, MakeSignature.CryptoStandard.CADES);
            stp.close();
            reader.close();
...
//                *            页面布局，横向或者纵向
        sign("C:/Users/Admin/Desktop/1234.pdf",//
                ...
                456f, 752f, null, 2, PageStyle.PAGE_STYLE_PORTRAIT);
        // read();
